...
export async function POST(request: Request) {
    ...
    try {
        ...
        console.error('Error ao fazer parsing do objeto: ', completion.data.choices[0].message.content)
